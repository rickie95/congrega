...
class SignUpBloc extends Bloc<SignUpEvent, SignUpState> {
  ...
  SignUpState _mapNameChangedToState(SignUpNameChanged event, SignUpState state) {
    ...
    return state.copyWith(
        name: name, status: Formz.validate([name, state.username, state.password]));
  }
  ...
  SignUpState _mapUsernameChangedToState(SignUpUsernameChanged event, SignUpState state) {
    ...
    return state.copyWith(
        username: username, status: Formz.validate([state.name, username, state.password]));
  }
  ...
  SignUpState _mapPasswordChangedToState(SignUpPasswordChanged event, SignUpState state) {
    ...
    return state.copyWith(
        password: password, status: Formz.validate([state.name, state.username, password]));
  }

  SignUpState _mapPasswordVisibilityChangedToState(
      SignUpPasswordVisibilityChanged event, SignUpState state) {
